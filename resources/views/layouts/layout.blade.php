    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link {{(Route::current()->getName() === 'site.about' ? 'active' : '')}}" href="{{route('site.about')}}">About</a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{(Route::current()->getName() === 'site.products' ? 'active' : '')}}" href="{{route('site.products')}}">Products</a>
          </li>
          <li class="nav-item">
